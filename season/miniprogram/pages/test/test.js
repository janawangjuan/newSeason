...
Page({
  ...
  data: {
    ...
    itemImgs: [{
      id: 1,
      url: "../../images/prize-img-1.png"
    }, {
      id: 2,
      url:"../../images/prize-img-2.png"
    }, {
      id: 3,
      url:"../../images/prize-img-4.png"
    }],
    tab1: { // 第一列当前显示的图片
      id: 1,
      url: "../../images/prize-img-1.png"
  ...
  getOpenAnimation: function(line, resNum) {
    ...
    let loop = setInterval(function() {
      ...
      if (count * tempRandom >= randomTotalTime) {
        ...
        animation.translate(-50+'%',-50+'%').step({
          duration: 0
        });
        handleSet(page);
        ...
        animation.translate(-50+'%',300).step().translate(-50+'%',-50+'%').step({
          duration: 0
        });
        handleSet(page);
      }
